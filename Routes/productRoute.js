...
productRoute.post('/addproduct',isLogin, productController.upload.array('productImg', 5), productController.addProduct);
productRoute.get('/editProduct/:id', isLogin,productController.editProductPage); 
productRoute.post('/editProduct/:id', isLogin, upload.array('editProductImages', 5), productController.editProduct);
